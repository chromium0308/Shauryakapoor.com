...
const CURRENT_PROJECTS: Project[] = [
  ...
  },
  {
    n: "03",
    year: "Now · 2026",
    name: "Self Docking Drone",
    cat: "Hardware · Self-Docking",
    desc: "A drone that deploys from a vertical surface and self-docks to a charging station using a magnetic hinge built into the dock.",
    tag: "Solidworks · Arduino",
    link: "Build log →",
    size: "s-3",
    image: "/assets/vdd.jpg",
    label: "Self-docking drone · concept",
  },
  {
    n: "04",
    year: "Now · 2026",
...
const COMPLETED_PROJECTS: Project[] = [
  {
    n: "06",
    year: "2026",
    name: "Pairs Trading AAPL & SPY",
    cat: "Quant · Statistical Arbitrage",
    desc: "A statistical arbitrage strategy that trades the mean-reverting spread between AAPL and SPY, backtested on historical price data.",
    tag: "Python",
    link: "GitHub →",
    href: "https://github.com/chromium0308/Pairs_trading_AAPL_and_SPY",
    size: "s-3",
    image: "/assets/pairs-trading.png",
    label: "Pairs Trading · AAPL / SPY",
  },
  {
    n: "07",
    year: "2025",
